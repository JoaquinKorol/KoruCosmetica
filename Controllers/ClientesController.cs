...
namespace KoruCosmetica.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(KoruCosmeticaContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ClienteID,Nombre,Apellido,Mail,Telefono")] Clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteID,Nombre,Apellido,Mail,Telefono")] Clientes clientes)
        {
